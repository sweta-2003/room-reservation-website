...
//sres.send("inside controllers..file received")
};
...
export const deleteHotel= async(req,res,next)=>{
    ...
    try {
       const deleteone= await Hotel.findByIdAndDelete(req.params.id);
       res.status(200).json(deleteone);
      } 
      catch (err) {
        console.log('error from delete hotel')
        next("errpr from delete hotel");
      }
